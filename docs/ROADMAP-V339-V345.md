...
| 3.44 | Comparar ofertas y registrar pedido parcial/plazo/incidencia/instalación; relación económica consistente sin duplicar contabilidad ni transferir dinero. | Reutilizar operaciones v3.35–3.37 y 3.39. Pruebas de parciales, incidencias, devoluciones, pagos separados y dos sesiones. | En curso |
