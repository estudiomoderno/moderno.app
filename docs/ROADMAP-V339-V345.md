...
| 3.43 | Aprobación corresponde a revisión exacta; alternativas identificadas; cambio relevante invalida aprobación; cantidades de presupuesto trazables; documentos emitidos intactos. | 3.39–3.42; pruebas de cambios, duplicados, cantidades, versiones antiguas y roles. | En curso |
