...
| 3.40 | IDs existentes preservados; referencias legacy resueltas sin adivinar; duplicados diagnosticados sin renombrado/fusión automática; maestro y especificación diferenciados. | Auditar prepare/resolve y consumidores; fixtures de mover, reordenar, duplicar y referencia ambigua. No migración global. | En curso |
