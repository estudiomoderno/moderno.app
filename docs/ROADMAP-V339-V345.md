...
| 3.40 | IDs existentes preservados; referencias legacy resueltas sin adivinar; duplicados diagnosticados sin renombrado/fusión automática; maestro y especificación diferenciados. | Auditar prepare/resolve y consumidores; fixtures de mover, reordenar, duplicar y referencia ambigua. No migración global. | Pendiente |
| 3.41 | Seleccionar acabado/variante/unidad y artículo a medida; origen identificable; actualización de maestro explícita y revisable sin tocar documentos anteriores. Estados de selección, aprobación y compra claramente separados. | 3.40, campos existentes y guardado protegido; demostrar dos especificaciones independientes del mismo maestro. | Pendiente |
| 3.42 | Board por estancia con pocas plantillas útiles, revisión conservada y proyecciones por audiencia que no filtren costes. Recursos privados fallidos se declaran. | 3.40–3.41, reutilizar editor/render/export existentes; ensayar permisos, imágenes, historial y exportación. | Pendiente |
