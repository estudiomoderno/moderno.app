...
Última versión: v3.32.2, publicada y verificada. Incluye hasta tres fotos opcionales por carpeta y transición suave. Ajuste visual: menú gris sin franja, carpetas beige claro y desplegables redondeados. Aplica la apariencia B elegida por el usuario, conserva iconos y menú contraíble y corrige el tablero móvil. Mantiene las protecciones de guardado, permisos y copias de v3.31. Véase [Entrega v3.32](ENTREGA-V332.md) y CHANGELOG.md.
