...
Actualización del 11 de septiembre: el PHP recuperado pasó 12 comprobaciones (SMTP real solo hasta autenticación, mensaje capturado localmente) y Google OAuth del clon pasó siete comprobaciones con cierre de sesión. Estos resultados resuelven las pruebas técnicas pendientes, con los límites de entrega externa y autorización descritos en RECUPERACION-SERVICIO.md.
