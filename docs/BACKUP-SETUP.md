...
La vigilancia horaria de copias fallidas o ausentes está configurada en Codex; ver MONITORIZACION-COPIAS.md. Depende de este ordenador y no sustituye una supervisión externa siempre encendida. El modo manual backup-service para respaldar api por FTPS al Drive empresarial está autorizado expresamente. Sus primeros intentos fallaron antes de descargar por discrepancia de nombre del certificado TLS; ver RECUPERACION-SERVICIO.md. Todavía no existe una copia verificada de api.
