...
La vigilancia horaria de copias fallidas o ausentes está configurada en Codex; ver MONITORIZACION-COPIAS.md. Depende de este ordenador y no sustituye una supervisión externa siempre encendida. El modo manual backup-service está preparado para respaldar api por FTPS al Drive empresarial; su primera ejecución está pendiente de autorización específica solicitada por la revisión automática.
