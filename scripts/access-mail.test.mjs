...
test('documented gap: locally editable admin label overrides membership role in navigation',()=>{const c=role('Administrador','miembro');assert.equal(c.myAccessLevel(),'owner');assert.equal(c.canView('facturas'),true);});
